    ...
    <section className="about" id="about">
      ...
      <div className="about__container ">
        <p>
          ...
          JavaScript, TypeScript and SQL programming languages. I am passionate
          about coding and can work on both sides of the stack, from building UI
          components on the front end, to implementing server side functionality
          on the back end.
        </p>
