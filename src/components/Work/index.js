        ...
        <div className="work__card">
          ...
          <div className="work__description">
            ...
            <p>
              ...
              and / or images to other users one-on-one or in groups. Users are
              required to create an account to use the app and can search for
              and add other users as contacts. Users can also edit their
              account.
            </p>
            ...
            <ul>
              ...
              <li>
                NodeJS for the Server (GraphQL API implemented with Apollo
                Server)
              </li>
